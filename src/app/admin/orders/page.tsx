            ...
            <div className="card border rounded-t-lg px-8 py-4 mt-5 shadow-sm bg-white">
                <div className="flex flex-col mb-4">
                    ...
                    <div className="flex gap-2 my-2 relative">
                        <select className="border shadow-sm appearance-none rounded-md p-2 px-4 text-sm border-gray-300/90 outline-none w-full" name="nomeCampanha" id="nomeCampanha">

                            {campanha.map((item) => {
                                return <option key={item.id} value="">{item.nomeCampanha}</option>
                            })}
                        </select>
                        <LuChevronDown
