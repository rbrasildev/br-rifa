            ...
            <div className="border border-t-0 rounded-b-lg overflow-hidden">
                <div className="p-4 border border-x-0 border-y-0">
                    ...
                    <ul className="flex gap-4 text-gray-400 border-b-1">
                        <li className="flex items-center gap-1"><LuCircleDollarSign />Valor R$ 1,44</li>
                        <li className="flex items-center gap-1"><LuTicket />6 bilhetes</li>
                        <li className="flex items-center gap-1"><LuCalendar />Criada em 19/02/2024, 07:14
                        </li>
                    </ul>
