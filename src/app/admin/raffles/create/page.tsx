    ...
    return (
        <DashboardLayout>
            ...
            <form>
                ...
                <div className="flex flex-col mb-4">
                    <label htmlFor="">Nome da campanha</label>
                    <input className="border shadow-sm rounded-md p-3 px-4 text-sm border-slate-200 outline-none" type="text" placeholder="0,00" />
                </div>
                <div className="flex flex-col mb-4">
                ...
                <button className="bg-[#22C55E] rounded-md flex gap-2 text-slate-50 items-center p-3 hover:bg-[#6fec9d] transition-all hover:text-slate-100 shadow-sm" type="submit" value="">Prosseguir <LuArrowRight/></button>
